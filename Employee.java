...
public class Employee {
	...
	public int writeToFile(Meeting currentNode) 
	{
		if (currentNode != null) 
		{
	...
	public void readFromFile()
	{
		  try 
		  {
			  ...
			  while (file.hasNext())
			  {
				  ...
				  String meetingString = parse.next();
				  Format format = new SimpleDateFormat();
				  Meeting currentNode = (Meeting)format.parseObject(meetingString);
				  ...
				  try
				  {
					  ...
					  mtTemp.addToMeetingTree(currentNode, startTime, endTime, description);
				  }
